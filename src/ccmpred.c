...
#ifndef _WIN32
                struct timeval run_timer; //setup_timer, exec_timer,  resulting_timer;
#else
                double run_timer; //setup_timer, exec_timer, resulting_timer;
#endif
...
//Print the run time
	...
	run_time = seconds_since( &run_timer);

#ifndef _WIN32
	// Total time measurement
	printf("\nTotal Run time: %.3f sec", run_time);
#endif
